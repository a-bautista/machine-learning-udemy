...
dataset = read.csv("C:\\Users\\abautista\\Desktop\\Machine_Learning_AZ_Template_Folder\\Part 2 - Regression\\Section 7 - Support Vector Regression (SVR)\\Position_Salaries.csv")
dataset = dataset[2:3]
