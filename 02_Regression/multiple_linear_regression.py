...
def data_processing():
    ...
    dataset = pd.read_csv("C:\\Users\\abautista\\PycharmProjects\\Machine_Learning_000\\02_Regression\\50_Startups.csv")
    ...
    # avoid the dummy variable trap, you do not take the column of index 0 - review lesson 35 and 36 for theory and
    # 39 for the programming stuff
...
def build_optimal_linear_regression_model(X_matrix_of_features_no_column_zero, y):
    ...
    # you fit the model with all the possible variable predictors through the ordinary least squares method
    # into the matrix of features and dependent variable
    regressor_OLS = sm.OLS(endog=y, exog=X_optimal).fit()

    # with the command from below you will find the P values of each variable and if it is above our significance
    # level (0.50) then we remove the variable with the highest P value.
